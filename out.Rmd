...
```
Comment: building the model using the training data. The svm machine learning algorithm is used for the prediction.The class is the output column that has to be predicted.    
```{r}
